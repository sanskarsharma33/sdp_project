...
from .views import Products,get_all_products,get_all_products_by_catagory,ProductImage, get_product, getProductImage
...
urlpatterns = [
    ...
    path('getproductimage/<int:id>', getProductImage.as_view(), name="getproductimage"),
